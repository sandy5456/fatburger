...
class IcItemCard extends StatefulWidget {
  List<Food> foods;
  int cId;
  String name;
  ...
  IcItemCard({this.foods, this.name,this.cId});
  @override
  _IcItemCardState createState() => _IcItemCardState();
}

class _IcItemCardState extends State<IcItemCard> {
...
Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
           if (widget.foods[index].catogeryid==85) {
