    ...
    return SafeArea(
      child: Row(
        children: <Widget>[
          ...
          Stack(
            children: <Widget>[
              IconButton(icon: //Image.network("https://cdn3.iconfinder.com/data/icons/hotel-service-gray-set-1/100/Untitled-1-02-512.png"),
            ...
            child: Column(
              children: <Widget>[
                TabBar(
                  ...
                  tabs: <Widget>[
                   Tab(
                     child: Image.network("https://i.pinimg.com/originals/00/cc/b6/00ccb6f59d1215f5666ad229af120e9f.png",height:30),
                   ),
                Tab(
                  child: Image.network("https://icons-for-free.com/iconfiles/png/512/bakery+svg+line+ice+cream-1319964862462914601.png",height: 30,),
                ),
                Tab(
                 child: Image.network("https://previews.123rf.com/images/branche/branche1311/branche131100127/23349105-plate-knife-spoon-and-fork.jpg"),
                ),
                Tab(
                  child: Image.network("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKk2FjDEpzeumxtNsQ_YqfjpJoKYeGWSqNsH24uymqqdl8rZDz&s",height: 30,),
                ),
              ],
            ),
            Expanded(
              child: TabBarView(
                children: <Widget>[HomeTopProperty(), IceCreams(), Food1(),Food1()],
              ),
            )
          ],
        ),
